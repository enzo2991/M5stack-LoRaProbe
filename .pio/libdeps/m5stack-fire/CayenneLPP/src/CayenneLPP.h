...
#define LPP_SNR 143                 // 1 byte, unsigned
#define LPP_HDOP 144                // 1 byte, unsigned
#define LPP_SAT 145                 // 1 byte, unsigned
#define LPP_RSSI 105                // 1 byte, 1 unsigned
...
#define LPP_RSSI_SIZE 4
#define LPP_SNR_SIZE 4
#define LPP_HDOP_SIZE 1
#define LPP_SAT_SIZE 1
...
#define LPP_RSSI_MULT 1
#define LPP_SNR_MULT 1
#define LPP_HDOP_MULT 1
#define LPP_SAT_MULT 1
...
public:
  ...
  uint8_t addRssi(uint8_t channel, uint32_t value);
#endif
#ifndef CAYENNE_DISABLE_HDOP
  uint8_t addHdop(uint8_t channel, uint32_t value);
#endif
#ifndef CAYENNE_DISABLE_SNR
  uint8_t addSnr(uint8_t channel, uint32_t value);
#endif
#ifndef CAYENNE_DISABLE_SAT
  uint8_t addSat(uint8_t channel, uint32_t value);
#endif
